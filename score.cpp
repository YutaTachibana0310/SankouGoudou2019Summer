...
HRESULT InitScore(void)
{
	...
	{
		g_score_max += 9 * (int)powf(10.0f, (float)nCntPlace);
	}
...
void DrawScore(void)
{
	...
	for (int nCntPlace = 0; nCntPlace < PLACE_MAX; nCntPlace++)
	{
		...
		number = g_score % (int)(powf(10.0f, (float)(PLACE_MAX - nCntPlace))) / (int)(powf(10.0f, (float)(PLACE_MAX - nCntPlace - 1)));
...
void ChangeScore(int value)
{
	...
	else if (g_score >= (int)(powf(10.0f, (float)(PLACE_MAX + 1))))
	{
		g_score = (int)(powf(10.0f, (float)(PLACE_MAX + 1))) - 1;
	}
